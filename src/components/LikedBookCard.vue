<template>
  <div v-if="user.liked.includes(book.id)" class="flex gap-[21.85px] rounded-[8px] border-[1px] border-transparent py-[9px] pl-[15.06px] pr-[15.63px] hover:border-x-lightgray hover:border-b-lightgray hover:shadow-[0px_12.5px_10px_-10px] hover:shadow-gray">
    ...
    <div class="mt-[50px] flex w-[203.92px] flex-col justify-between">
      ...
      <div class="mr-[32.7px] self-end">
        ...
        >
          <FontAwesomeIcon
              :icon="['fas', 'heart']"
              class="h-[20.06px] w-[23.41px] text-red group-hover:text-red-800 group-active:text-red-800"
          />
        </button>
      </div>
    </div>
